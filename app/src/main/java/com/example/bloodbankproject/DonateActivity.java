...
public class DonateActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Area_List = ArrayAdapter.createFromResource(this, R.array.kathmandu_arrays, android.R.layout.select_dialog_item);
    ...
    private void updateAreaSpinner(String city) {
        ...
        if(city.equals("Kathmandu"))
        {
            aid = R.array.kathmandu_arrays;
        }
        else if(city.equals("Lalitpur"))
        {
            aid = R.array.lalitpur_arrays;
        }
        else if(city.equals("Bhaktapur"))
        {
            aid = R.array.bhaktapur_arrays;
        }
